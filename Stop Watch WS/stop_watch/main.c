...
void Timer1_CTC_init(){ // function to make timer1 count 1 second
	...
	TCCR1B = (1<<WGM12) | (1<<CS10) | (1<<CS11); // CTC mode with OCR1A as top (mode 4), prescaler of 64
	//TCCR1B = (1<<WGM12) | (1<<CS10) | (1<<CS12); // CTC mode with OCR1A as top (mode 4), prescaler of 1024 for the hardware
...
ISR(INT2_vect){ // resume the stop watch
	...
	//TCCR1B |= (1<<CS10) | (1<<CS12); //prescaler of 1024 for the hardware
}
